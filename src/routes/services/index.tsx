...
const DESCRIPTION =
  "Ολοκληρωμένες υπηρεσίες ψυχικής υγείας στο Γαλάτσι: συμβουλευτική, ψυχοθεραπεία, ζευγάρι, παιδική & εφηβική ψυχολογία, ΔΕΠΥ, επαγγελματικός προσανατολισμός, γονεϊκή καθοδήγηση.";
      ...
      <section className="bg-secondary/40 py-16 md:py-24">
        <div className="mx-auto max-w-4xl px-4 text-center md:px-8">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground md:text-lg">
            {visible.length} εξειδικευμένες υπηρεσίες για παιδιά, εφήβους, ενήλικες, ζευγάρια και
            οικογένειες. Δεν είστε σίγουροι ποια σας ταιριάζει; Καλέστε μας — θα σας
            προσανατολίσουμε.
          </p>
        </div>
      </section>
