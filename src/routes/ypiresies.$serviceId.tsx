...
function ServiceDetailPage() {
  ...
  const Icon = getService(service.id)!.icon;
    ...
    <>
        ...
        <div className="relative mx-auto max-w-4xl px-4 md:px-8">
          ...
          <div className="mt-8 flex flex-col items-start gap-6 md:flex-row md:items-center">
            ...
            <div>
              ...
              <p className="mt-3 text-base text-foreground/80 md:text-lg">{service.subtitle}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-background py-14 md:py-20">
        <div className="mx-auto grid max-w-5xl gap-10 px-4 md:grid-cols-2 md:px-8">
          ...
          <div>
            <h2 className="font-serif text-2xl text-ink md:text-3xl">Σε ποιους απευθύνεται</h2>
            <ul className="mt-6 space-y-3">
      ...
      <section className="bg-secondary/40 py-14 md:py-20">
        <div className="mx-auto max-w-3xl px-4 text-center md:px-8">
          <h2 className="font-serif text-3xl text-ink md:text-4xl">Έτοιμοι να ξεκινήσετε;</h2>
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-muted-foreground">
            Επικοινωνήστε μαζί μας για να κλείσετε το πρώτο σας ραντεβού ή για να λάβετε
      ...
      <section className="bg-background py-14 md:py-20">
        <div className="mx-auto max-w-6xl px-4 md:px-8">
          <h2 className="font-serif text-2xl text-ink md:text-3xl">Σχετικές Υπηρεσίες</h2>
